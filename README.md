...
Код, отвечающий за работу записи, прописан в приложениях appointment. Параметры  записи:  имя,  номер  телефона  и  т.д.  вводятся пользователем на соответствующей странице и передаются в БД. В панели администратора можно посмотреть пользовательские записи.  
